...
CATEGORIES: list[dict] = [
    ...
    {"name": "Email", "icon": "fas fa-envelope", "description": "Outlook, Exchange, and email client problems"},
    ...
    {"name": "Authentication", "icon": "fas fa-key", "description": "Login, password, MFA, Active Directory, and access issues"},
